...
Takes a vector of date/datetime strings and standardizes their format to `yyyy-mm-ddThh:mm:ssZ`

TO DO: I think its fine to ask a user to input dates as yyyy/mm/dd and datetimes as yyyy/mm/ddThh:mm:ss. I'd also like them to be able to specify their time zone and translate that into UTC for them. So this function should accept a date OR a datetime and if it is not in UTC, convert it to UTC.
